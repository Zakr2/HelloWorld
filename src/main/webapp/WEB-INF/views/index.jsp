...
<header>
    ...
    <option><spring:message code="english"/><a href="<%=request.getContextPath()%>?languageVar=en">EN</a></option>
    <option><spring:message code="russian"/><a href="<%=request.getContextPath()%>?languageVar=ru">RU</a></option>
</form></select>
</header>
